      ...
      <nav className="navbar p-0 bg-base-100">
        ...
        <div className="navbar-end flex items-center gap-3">
          <label className="swap swap-rotate hidden md:grid">
            <input type="checkbox" checked={theme === 'dark' ? true : false} onChange={handleTheme} />
          ...
          <div className="group relative cursor-pointer">
            ...
            <span className="absolute w-[200px] text-center p-2 rounded-md bg-violet-700 z-50 text-white group-hover:top-10 -top-48 right-0 transition-all duration-300 pointer-events-none">
